...
class TestRunner(BTCRunner2):
    ...
    async def _create_order(
        self, order_blocks: list[OrderBlock], mutex_order_blocs: list[OrderBlock], klines: list[KLine]
    ):
    ...
    async with settings.exchange.create_async_exchange() as exchange:
        ...
        options = [
            CustomRunnerOptions(
                ...
                timeframe="30m",
                position_strategy={"strategy": "elasticity", "kwargs": {"base_total_usdt": 1000, "base_usdt": 25}},
